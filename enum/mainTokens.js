...
EnumMainTokens[EnumChainId.NZT].STABLE_COINS = [ "USDT" ].map( e => EnumMainTokens[EnumChainId.NZT][e].address );
EnumMainTokens[EnumChainId.NZT].MAIN = EnumMainTokens[EnumChainId.NZT]["WNZT"];
