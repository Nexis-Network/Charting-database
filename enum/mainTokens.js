...
EnumMainTokens[EnumChainId.XZO].STABLECOINS = [ "BUSD", "USDC", "USDT", "DAI" ].map( e => EnumMainTokens[EnumChainId.XZO][e].address );
EnumMainTokens[EnumChainId.XZO].MAIN = EnumMainTokens[EnumChainId.XZO]["WBNB"];
